<%@ Page Title="" Language="C#" MasterPageFile="~/Airline/AirlineMaster.master" AutoEventWireup="true" CodeFile="Flight Details.aspx.cs" Inherits="Airline_Flight_Details" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table align="center" cellpadding="3" cellspacing="0" class="style5">
        <tr>
            <td colspan="2" style="text-align: center; font-weight: 700" class="style11">
                Flight Details</td>
        ...
        <tr>
            <td class="style12">
                <asp:DropDownList ID="drpstart" runat="server" 
                    ...
                    onselectedindexchanged="drpstart_SelectedIndexChanged">
                </asp:DropDownList>
