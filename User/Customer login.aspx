<%@ Page Title="" Language="C#" MasterPageFile="~/User/UserMaster.master" AutoEventWireup="true" CodeFile="Customer login.aspx.cs" Inherits="User_userlogin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table align="center" cellpadding="10" cellspacing="10" width="400" 
        ...
        <tr>
            <td>
                <asp:TextBox ID="txtpassword" runat="server" Height="40px" Width="300px" placeholder="Enter Password"
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br />
                ...
                Don&#39;t Have An Account ?&nbsp;
                    ...
                    NavigateUrl="~/User/Customer_Registration.aspx">Sign Up Now</asp:HyperLink>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                </td>
        </tr>
    </table>
